...
public class ChuKi_model {
    ...
    public static void main(String[] args) {
        try {
            // Create an instance of ChuKi_model
            ...
            // Sign the message and get the Base64 encoded signature
            String signedMessage = chuKiModel.signMessage(message);
            System.out.println("Signed message: " + signedMessage); // Display the signed message

            // Now verify the signature using the original message and the Base64 signature
            boolean isVerified = chuKiModel.verifySignature(message, signedMessage);
            System.out.println("Is the signature valid? " + isVerified); // Print if the signature is valid
