...
<body>
	...
	<form action="checkout" method="POST">
		...
		<!-- Card 2: Thông tin khách hàng và địa chỉ nhận hàng -->
		<div class="card" style="height: 430px;">
			<h2>Thông Tin Khách Hàng & Nhận Hàng</h2>
			
				<div class="form-group">
					<label for="customer-name">Tên Khách Hàng:</label> <input
						type="text" id="customer-name" name="customer-name" required>
				</div>
				<div class="form-group">
					<label for="customer-email">Email:</label> <input type="email"
