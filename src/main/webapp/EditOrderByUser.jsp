...
<jsp:include page="Header.jsp" />
	<div class="container-checkout">
		<form action="updateOrderByUser?orderID=${order.orderID}" method="POST">
			...
			<div class="card" style="height: 350px;">
				...
				<div class="form-group">
					<label for="customer-name">Tên Người Nhận:</label> <input
						type="text" id="customer-name" name="customer-name" value="${order.customerName}">
				</div>
				
					<div class="form-group">
					<label for="customer-email">Email:</label> <input
						type="text" id="customer-email" name="customer-email" value="${order.customerEmail}">
				</div>

				<div class="form-group">
					<label for="customer-phone">Số Điện Thoại:</label> <input
						type="tel" id="customer-phone" name="customer-phone" value="${order.customerPhone}">
				</div>

				<div class="form-group">
					<label for="customer-address">Địa Chỉ:</label> <input type="text"
						id="customer-address" name="customer-address" value="${order.customerAddress}">
				</div>
