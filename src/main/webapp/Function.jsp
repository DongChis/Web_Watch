...
<div class="card">
    ...
    <div class="key-info">
        <p><strong>Tài khoản sở hữu:</strong> <span>${sessionScope.accSession.username}</span></p>
        <p><strong>Thời gian tạo:</strong> <span id="createdTime">${createTime}</span></p>
        <p><strong>Hiệu lực đến:</strong> <span id="validUntil">${endTime}</span></p>
        ...
        <div class="key-display">
            ...
            <%-- <!-- Private Key Display -->
            <c:choose>
                <c:when test="${not empty privateKey}">
                    <div class="key-item">
...
<div class="card">
    ...
    <div id="keyDisplay" class="key-display" style="display:none;">
        ...
        <div class="key-item">
            <p><strong>Private Key:</strong></p>
            <p id="privateKeyMessage">Khóa riêng tư không hiển thị. Bạn có thể tải về.</p>
            <button id="downloadPrivateKey" class="btn">Tải về Private Key</button>
        </div>
    </div>
</div>
    ...
    <div class="card">
        ...
        <form id="keyImportForm" action="keyControl" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <button type="submit" class="btn">Nhập Khóa</button>
            </div>
        </form>
    </div>
    ...
    <div class="card">
        ...
        <form id="keyReportForm" action="keyControl" method="POST">
            ...
            <div class="form-group">
                <label for="reportPrivateKey">Nhập khóa Private cần báo mất:</label>
                <input type="text" id="reportPrivateKey" name="reportPrivateKey" required />
            </div>
            <div class="form-group">
